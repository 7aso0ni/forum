...
func SeedFakeData(db *sql.DB) error {
	...
	users := []models.UserRegisteration{
		{Username: "johndoe", Email: "johndoe@example.com", Password: "johndoe"},
		{Username: "janedoe", Email: "janedoe@example.com", Password: "janedoe"},
		{Username: "bobsmith", Email: "bobsmith@example.com", Password: "bobsmith"},
		{Username: "alicejones", Email: "alicejones@example.com", Password: "alicejones"},
		{Username: "mikebrown", Email: "mikebrown@example.com", Password: "mikebrown"},
		{Username: "example1234", Email: "example1234@example.com", Password: "example1234"},
	}
